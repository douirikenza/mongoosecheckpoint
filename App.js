...
const arrayOfPeople = [
  { name: "Ali", age: 30, favoriteFoods: ["slata"] },
  { name: "Sofia", age: 32, favoriteFoods: ["sandwich", "pizza", "hamburgur"] },
  { name: "Sara", age: 45, favoriteFoods: ["bsissa", "tamr"] },
];
